namespace Cik.MagazineWeb.WebApp.Controllers
{
    ...
    using Cik.MagazineWeb.WebApp.Models;
    ...
    public class AccountControllerTests
    {
        ...
        public void PasswordLengthTest()
        {
            ...
            var result = controller.PasswordLength("126678");
        ...
        {
            var controller = new Cik.MagazineWeb.WebApp.Controllers.AccountController();
            var result = controller.UserNameLength("1266");
            Assert.IsTrue(result);
